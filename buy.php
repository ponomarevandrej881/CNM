...
// сделать проверку на пустые поля (решено)
// сделать проверку на номер карты 6666000000000000 - 6666999999999999 (решено)
// сделать проверку пин кода 1000 - 9999 (решено)
// сделать окна ошибок(решено)
// сделать номера чеков (решено)
// переработать и упростить чек (решено)
// сделать ответ на обратную связь (решено)
// БАГ: при выборе 1 позиции оно дублирует позицию и вторую не принимает
// первести названия кнопок (решено)
// исправить колбасу копченую (решено)
// Сделать инструкцию и рекламу в магазине (решено)
